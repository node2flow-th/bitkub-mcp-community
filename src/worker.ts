...
export default {
  async fetch(request: Request): Promise<Response> {
    ...
    const apiKey = url.searchParams.get('BITKUB_API_KEY') || '';
    const secretKey = url.searchParams.get('BITKUB_SECRET_KEY') || '';
    const config = apiKey && secretKey ? { apiKey, secretKey } : undefined;
